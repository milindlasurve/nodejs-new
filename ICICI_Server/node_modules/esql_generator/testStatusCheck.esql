...
CREATE COMPUTE MODULE Ecollection_LEND_File_To_JSON_CheckStatus
	...
	BEGIN
		...
		Reject : WHILE (i <= statusLength) DO
						...
						IF( UPPER (InputRoot.JSON.Data."Virtual Account Number Verification OUT"."Item"."Reserved7") =UPPER( Environment.Variables.Status[i].FT_STATUS)) THEN
						...
						ELSEIF ( UPPER (InputRoot.JSON.Data."Virtual Account Number Verification OUT"."Item"."Reserved7") = UPPER(Environment.Variables.Status[i].REFUND_STATUS)) THEN
