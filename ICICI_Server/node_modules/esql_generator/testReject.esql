		...
		Reject : WHILE (i <= statusLength) DO
			...
			IF( UPPER (InputRoot.JSON.Data."Virtual Account Number Verification IN"."item"."Status") = Environment.Variables.Status[i].REFUND_STATUS) THEN
				...
				SET OutputRoot.DFDL.ns1:REL_AcceptReject.record.ValidationStatus = InputRoot.JSON.Data."Virtual Account Number Verification OUT".Item.Status;
							...
							-- Code --
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."RejectReason"=COALESCE( InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."Reject Reason",'Reason not Specified');
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."ValidationStatus"= InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."Status";
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."RejectionReason"= InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."Virtual Account Number";
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."Reserved7"=CAST( InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."Transaction Amount" AS INTEGER CCSID 1208);
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."Reserved8"= InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."Mode";
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."Reserved9"= InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."UTR number";
SET OutputRoot.DFDL.ns1:REL_AcceptReject.record."Reserved10"= InputRoot.XMLNSC.BANK."Virtual Account Number Verification IN"."item"."Sender Name";
