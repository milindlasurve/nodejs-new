...
// async function soapReader(wsdl){
// //var Q = require('q');
// var deferred = q.defer();
// var returnSoapReader = await soap.createClient(wsdl,async function(err,client){
// 		if(err){
// 			console.error("Error ::",err);
// 		}
// 		else{
// 			wsdlObject = client.describe();

// 			console.log("WSDL DATA :::: ",JSON.stringify(wsdlObject));
// 			 //console.log("Flatteneddddddddddd Value ::: ",flattenedObject);
// 			// console.log("JSON Tree : ",JSON.stringify(unflattenedObject));
		  
//   	  	  	var returnExtraVal = await readWsdl(wsdlObject);	

// 		     console.log("Final Data :  ",returnExtraVal)
// 		    // console.log("Final Structured Data : ",JSON.stringify(structuredData));
// 		    // console.log("Final UnStructured But Needed Data : ",(allObjects));
// 		    // console.log("Unflattened",JSON.stringify(await formHierarchy(cleanedData)));
		  
// 		    if(returnExtraVal){
// 		    	deferred.resolve({returnExtraVal});
// 		    }
// 		}
...
async function readWsdl(wsdlData){
	...
	for(var key in wsdlData){
		...
		if(key){
          //  console.log("Return ",returnReadWsdl)
			return allObjects;
		}
	}
			...
			if(!val){
				if(treeLevel==1){
					...
					/* Variable to store Request or Response Type. It changes after calling flatten method */
						...
						allObjects.push({endpoint:endpoint,Operations:{operationId:operations,fields:tree,type:reqRes}})
										
					}
					//console.log(operations," ::::Parent ::    4 :::::",key);
				 }				
